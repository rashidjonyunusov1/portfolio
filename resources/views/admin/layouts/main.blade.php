...
<head>
    <meta charset="utf-8">
    <title>Rashidjondev.uz/admin/dashboard</title>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{ route('admin.abouts.index')}}" class="dropdown-item">About</a>
                            <a href="{{ route('admin.contacts.index')}}" class="dropdown-item">Contacts</a>
                            <a href="{{ route('admin.facts.index')}}" class="dropdown-item">Facts</a>
                            <a href="{{ route('admin.forms.index')}}" class="dropdown-item">Forms</a>
                            <a href="{{ route('admin.home.index')}}" class="dropdown-item">Home</a>
                            <a href="{{ route('admin.portfolios.index')}}" class="dropdown-item">Portfolio</a>
                            {{-- <a href="{{ route('admin.profile_img.index')}}" class="dropdown-item">Profile</a> --}}
                    ...
                    <a href="{{ route('admin.forms.index')}}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Forms</a>
